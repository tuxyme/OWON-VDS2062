  ...
  extends JDialog
{
  ...
  public KeepNoticeDialog(Window owner)
  {
    ...
    JPanel jp = new JPanel()
    {
      protected void paintComponent(Graphics g)
      {
        ...
        int wc = w >> 1;
        int hc = h >> 1;
        g2d.setFont(KeepNoticeDialog.font);
        ...
        g2d.setColor(KeepNoticeDialog.CO_FADE_BG);
  ...
  public void keepShow(final int time)
  {
    new Thread()
    {
      public void run()
      {
        KeepNoticeDialog.this.nofading(time);
      }
    }.start();
  }
...
/* Location:
 * Qualified Name:     com.owon.uppersoft.vds.ui.prompt.KeepNoticeDialog
